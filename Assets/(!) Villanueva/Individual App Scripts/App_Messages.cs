...
public class App_Messages : MonoBehaviour
{
    ...
    public void OpenMessageThread(GameObject messageThreadPage)
    {
        ...
        messageThreadPage.transform.DOMove(messageOpenedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic);
        ReplyBox.transform.DOMove(ReplyBoxClosedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic); //Fancy appearing of reply box - Nicaia
    ...
    public void ReturnToContacts(GameObject InboxPage)
    {
        ...
        ReplyBox.transform.DOMove(ReplyBoxHidePosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic); //Fancy hiding of reply box - Nicaia
        transform.DOMove(messageClosedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic)
        .OnComplete(() =>
        {
    ...
    public void ShowReplyOptions(GameObject replyBox)
    {
        ...
        ReplyBox.transform.DOMove(ReplyBoxOpenedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic);
    }
    ...
    public void SelectReply(GameObject replyBox) //Hey, why the fuck does this one not work. bruh
    {
        ...
        ReplyBox.transform.DOMove(ReplyBoxClosedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic);
    }
