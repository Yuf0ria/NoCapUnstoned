...
public class App_Postmail : MonoBehaviour
{
    ...
    public void OpenMailThread(GameObject MailThreadPage)
    {
        ...
        MailThreadPage.transform.DOMove(MailOpenedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic);
    ...
    public void ReturnToInbox(GameObject InboxPage)
    {
        ...
        transform.DOMove(MailClosedPosition.position, TransitionTime * TransitionMult).SetEase(Ease.OutCubic)
        .OnComplete(() =>
        {
