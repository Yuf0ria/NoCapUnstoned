...
public class App_Basic : MonoBehaviour
{
    ...
    [SerializeField] Vector3 ClosedScale = new Vector3(0, 0, 0);
    [SerializeField] Vector3 OpenedPoint; //= new Vector3(540, 960, 0);
    [SerializeField] Vector3 OpenScale = new Vector3(1, 1, 1);
